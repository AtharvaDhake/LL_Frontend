...
import { registerUser } from '../redux/slice/authSlice'; // Fixed typo authslice -> authSlice
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-8 bg-white animate-fade-in-up">
        ...
        >
          <div className="text-center mb-5">
            ...
            <p className="text-sm text-gray-500 mt-2">Join Learning Lounge today!</p>
          </div>
      ...
      <div className="hidden md:flex w-1/2 relative bg-gray-900">
         <img 
          ...
          <div className="absolute inset-x-0 bottom-0 p-8 lg:p-12 text-white bg-gradient-to-t from-black/90 via-black/50 to-transparent">
             <h2 className="text-3xl lg:text-4xl font-bold mb-4">Unlock Your Potential</h2>
             <p className="text-base lg:text-lg opacity-90 max-w-md">Join a community of learners and start your journey with the best educational resources tailored just for you.</p>
          </div>
      </div>
    </div>
  );
